...
//         document.querySelector('ul').append(finaluser);
//         //scrollToBottom();
//         console.log(text.value);
...
//     //window.scrollTo(0, document.querySelector(".main-chat-window").scrollHeight);
//     var d = document.querySelector('body > div > div.main-right > div.main-chat-window');
